...
21	1999	Etat 4/10	7	4	0	521000.00	33000000.00	2024-01-29	19:12:16.099	5	3	2	3	3
\.
...
COPY public.photo (size, contenttype, id_photo, name, data, idannonce) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.annonce_idannonce_seq', 21, true);
...
--
-- Name: photo photo_idannonce_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.photo
    ADD CONSTRAINT photo_idannonce_fkey FOREIGN KEY (idannonce) REFERENCES public.annonce(idannonce);
